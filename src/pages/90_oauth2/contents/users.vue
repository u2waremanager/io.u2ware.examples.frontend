    ...
    <v-card>
      ...
      <v-dialog v-model="dialog" persistent width="800">
        <v-card
          ...
          :title="$t('oauth2.contents.users.title')"
...
export default {
  ...
  methods: {
    ...
    ////////////////////////////////////////
    handleCreate(){
      return $oauth2Server.users.create(this.editForm);
    },
    handleValidate(){
      return $oauth2Server.users.exists(this.editForm);
    },    
    handleRead(entity){
      return $oauth2Server.users.read(entity);
    },
    handleUpdate(){
      return $oauth2Server.users.update(this.editForm);
    },
    handleDelete(){
      return $oauth2Server.users.delete(this.editForm);
    },
    handleSearch(query){
      return $oauth2Server.users.search(this.searchForm, query);
    },
    handleEntities(res){
